# -*- coding: utf-8 -*-
"""
Train multiple agents on the custom speedway track with VELOCITY DELTA ACCELERATION SYSTEM.

Current reward system (positive reinforcement for gradual acceleration):
- POSITIVE: +1000 progress, +30 speed (straights), +15 acceleration (speed increases), +10 speed (corners)
- CORNER BONUSES: +50 brake in sharp corners, +30 coast in sharp corners
- NEGATIVE: -50 reckless (full throttle in corners), -20 steer abuse, -10 crash, -5 off-road, -5 white-line, -3 no-progress, -2 slow
- NO ACTION PENALTIES: Agent free to explore without jitter penalties
- FOCUS: Learn gradual acceleration through positive rewards, not restrictive penalties

Usage:
    python train_multi_custom_speedway_curve.py --agent-names F11 --timesteps 500000
    python train_multi_custom_speedway_curve.py --num-agents 2 --agent-names Alek Saegan --timesteps 500000
"""
    ...
    def _init():
        ...
        env_config = {
            ...
            'map_config': {
                ...
                'lane_width': 8.0,  # Wider lanes - agents won't insta-die for small errors
            },
...
def main():
    ...
    print("  Lenient boundaries (out_of_road_done=False)")
    print("="*70 + "\n")

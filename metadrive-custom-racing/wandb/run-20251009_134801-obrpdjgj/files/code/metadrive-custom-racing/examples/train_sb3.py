...
def main():
    ...
    if resume_path and os.path.exists(resume_path):
        ...
        # Update the learning rate (CRITICAL: Update both model attribute AND optimizer)
        model.learning_rate = args.learning_rate
        # CRITICAL: Update the actual optimizer learning rate
        for param_group in model.policy.optimizer.param_groups:
            param_group['lr'] = args.learning_rate
        print(f"✅ Learning rate updated in optimizer: {args.learning_rate}")
